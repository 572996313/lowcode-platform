...
export const componentMap: Record<string, () => Promise<any>> = {
  ...
  '/views/layout/components/SidebarItem.vue': () => import('@/views/layout/components/SidebarItem.vue'),
  '/views/layout/index.vue': () => import('@/views/layout/index.vue'),
  '/views/login/index.vue': () => import('@/views/login/index.vue'),
  '/views/lowcode-v6/FreeCanvasDesigner.vue': () => import('@/views/lowcode-v6/FreeCanvasDesigner.vue'),
  '/views/lowcode-v6/FreeCanvasRender.vue': () => import('@/views/lowcode-v6/FreeCanvasRender.vue'),
  ...
  '/views/lowcode-v6/SmartPageRender.vue': () => import('@/views/lowcode-v6/SmartPageRender.vue'),
