...
public class CodeGenerator {
    ...
    private static final String MODULE_NAME = "edu";             // 模块名
    private static final String TABLE_NAME = "edu_student";      // 数据库表名
    private static final String ENTITY_NAME = "Student";         // 实体类名
    private static final String TABLE_NAME_CN = "学生信息";      // 表中文名
    private static final String PRIMARY_KEY_LABEL = "学生ID";    // 主键说明
