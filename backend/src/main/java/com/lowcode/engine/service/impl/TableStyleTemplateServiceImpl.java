package com.lowcode.engine.service.impl;
...
import com.lowcode.engine.entity.TableStyleTemplate;
import com.lowcode.engine.mapper.TableStyleTemplateMapper;
import com.lowcode.engine.service.ITableStyleTemplateService;
import com.lowcode.system.service.ISysDictReferenceService;
...
public class TableStyleTemplateServiceImpl extends ServiceImpl<TableStyleTemplateMapper, TableStyleTemplate>
    ...
    public boolean save(TableStyleTemplate entity) {
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public boolean updateById(TableStyleTemplate entity) {
    ...
    public boolean removeById(Serializable id) {
        ...
        dictReferenceService.removeByResource(
                ISysDictReferenceService.RESOURCE_TYPE_TABLE_TEMPLATE, (Long) id);
     ...
     * 更新模板相关的字典引用
     */
    private void updateDictReferences(TableStyleTemplate template) {
        // 删除旧的引用
        dictReferenceService.removeByResource(
                ISysDictReferenceService.RESOURCE_TYPE_TABLE_TEMPLATE, template.getId());
            ...
            try {
                ...
                for (String dictCode : dictCodes) {
                    dictReferenceService.addReference(
                            dictCode,
                            ISysDictReferenceService.RESOURCE_TYPE_TABLE_TEMPLATE,
                            template.getId(),
                ...
                log.debug("更新表格模板字典引用: template={}, dicts={}", template.getTemplateName(), dictCodes);
            } catch (Exception e) {
