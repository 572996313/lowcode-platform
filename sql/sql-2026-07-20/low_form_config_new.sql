...
INSERT INTO lowcode_platform.low_form_config_new (id, form_name, form_code, dataset_id, field_widgets, layout_type, layout_config, form_type, status, deleted, create_by, create_time, update_time) VALUES (1, '用户编辑表单', 'user_edit_form', 1, '[{"fieldCode": "username", "widgetType": "input", "widgetConfig": {"span": 12, "required": true, "labelWidth": 100, "placeholder": "请输入用户名"}}, {"fieldCode": "nickname", "widgetType": "input", "widgetConfig": {"span": 12, "required": false, "labelWidth": 100, "placeholder": "请输入昵称"}}, {"fieldCode": "email", "widgetType": "input", "widgetConfig": {"span": 12, "required": false, "labelWidth": 100, "placeholder": "请输入邮箱"}}, {"fieldCode": "phone", "widgetType": "input", "widgetConfig": {"span": 12, "required": false, "labelWidth": 100, "placeholder": "请输入手机号"}}, {"fieldCode": "status", "widgetType": "select", "widgetConfig": {"span": 12, "options": [{"label": "启用", "value": 1}, {"label": "禁用", "value": 0}], "required": false, "labelWidth": 100, "placeholder": "请选择状态"}}]', 'horizontal', null, 'edit', 1, 0, 'admin', '2026-03-04 18:30:39', '2026-03-04 18:30:39');
