...
INSERT INTO lowcode_platform.low_page_config_new (page_name, page_code, dataset_id, display_fields, layout_type, layout_config, route_path, published, config_json, status, deleted, create_by, create_time, update_time, publish_time) VALUES ('用户列表页面', 'user_list_page', 1, '[{"label": "ID", "order": 1, "visible": true, "fieldCode": "id"}, {"label": "用户名", "order": 2, "visible": true, "fieldCode": "username"}, {"label": "昵称", "order": 3, "visible": true, "fieldCode": "nickname"}, {"label": "邮箱", "order": 4, "visible": true, "fieldCode": "email"}, {"label": "手机号", "order": 5, "visible": true, "fieldCode": "phone"}, {"label": "状态", "order": 6, "visible": true, "fieldCode": "status"}]', 'top-bottom', null, '/user/list', 1, null, 1, 0, 'admin', '2026-03-04 18:30:39', '2026-03-04 18:30:39', null);
