...
INSERT INTO lowcode_platform.low_page_template (template_name, template_code, template_type, layout_type, preview_image, config_json, config_template, description, is_system, status, deleted, create_by, create_time, update_time) VALUES ('标准列表页', 'standard-list', 'list', 'top-bottom', null, null, '{
        "version": 2,
...
INSERT INTO lowcode_platform.low_page_template (template_name, template_code, template_type, layout_type, preview_image, config_json, config_template, description, is_system, status, deleted, create_by, create_time, update_time) VALUES ('左树右表', 'tree-table', 'list', 'tree-table', null, null, '{"areas": [{"id": "tree-area", "name": "树形导航区", "type": "tree", "config": {"title": "导航树", "configId": null, "componentType": "tree"}, "enabled": true, "required": "false"}, {"id": "search-area", "name": "查询条件区", "type": "search", "props": {"fields": []}, "config": {"collapsible": true}, "enabled": true, "required": false}, {"id": "toolbar-area", "name": "工具栏", "type": "toolbar", "props": {"buttons": []}, "enabled": true, "required": "false"}, {"id": "content-area", "name": "内容区", "type": "content", "config": {"title": "数据列表", "configId": null, "componentType": "table"}, "enabled": true, "required": "false"}], "version": 2, "pageInfo": {"title": "左树右表", "description": "左侧树形导航，右侧数据表格"}, "layoutType": "tree-table", "templateCode": "tree-table"}', '左侧显示树形导航结构，右侧显示对应的数据表格。适用于分类管理、层级数据展示等场景。', 1, 1, 0, null, '2026-01-30 11:56:24', '2026-01-31 04:44:27');
