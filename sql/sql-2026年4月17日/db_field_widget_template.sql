...
INSERT INTO lowcode_platform.db_field_widget_template (table_id, field_id, template_name, template_code, widget_type, widget_config, is_system, description, enabled, sort_order, create_time, update_time, deleted) VALUES (5, 72, 'df', 'df', 'textarea', '{"label":"数据源ID","placeholder":"请输入数据源ID","required":true,"span":12}', 0, '', 1, 0, '2026-02-01 17:18:08', '2026-02-01 17:18:28', 1);
