...
INSERT INTO lowcode_platform.low_field_linkage (rule_name, rule_code, source_field, target_field, linkage_type, condition_config, action_config, description, status, deleted, create_by, create_time, update_time) VALUES ('VIP用户显示等级', 'vip_show_level', 'userType', 'vipLevel', 'visibility', '{"value": "vip", "operator": "equals"}', '{"visible": true}', '当用户类型为VIP时，显示VIP等级字段', 1, 0, null, '2026-03-04 18:31:05', '2026-03-04 18:31:05');
INSERT INTO lowcode_platform.low_field_linkage (rule_name, rule_code, source_field, target_field, linkage_type, condition_config, action_config, description, status, deleted, create_by, create_time, update_time) VALUES ('国家省份联动', 'country_province', 'country', 'province', 'options', '{"operator": "not_empty"}', '{"dictCode": "province_{country}", "dataSource": "dict"}', '根据选择的国家加载对应的省份数据', 1, 0, null, '2026-03-04 18:31:05', '2026-03-04 18:31:05');
INSERT INTO lowcode_platform.low_field_linkage (rule_name, rule_code, source_field, target_field, linkage_type, condition_config, action_config, description, status, deleted, create_by, create_time, update_time) VALUES ('邮箱通知必填', 'email_required', 'enableEmailNotification', 'email', 'required', '{"value": true, "operator": "equals"}', '{"required": true}', '当启用邮箱通知时，邮箱地址变为必填项', 1, 0, null, '2026-03-04 18:31:05', '2026-03-04 18:31:05');
INSERT INTO lowcode_platform.low_field_linkage (rule_name, rule_code, source_field, target_field, linkage_type, condition_config, action_config, description, status, deleted, create_by, create_time, update_time) VALUES ('审核后只读', 'audited_readonly', 'status', 'auditTime', 'readonly', '{"value": ["approved", "rejected"], "operator": "in"}', '{"readonly": true}', '状态为已审核或已拒绝时，审核时间字段变为只读', 1, 0, null, '2026-03-04 18:31:05', '2026-03-04 18:31:05');
